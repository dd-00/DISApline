...
export const metadata = {
  title: 'Risk Disclosures — DISApline',
  description: 'Important risk disclosures and regulatory notices for DISApline users.',
}
...
export default function DisclosuresPage() {
  return (
    <LegalPage
      ...
      subtitle="Important notices you must read before using DISApline"
      ...
      sections={[
        {
          ...
          content: (
            <>
              <p>
                <strong>DISApline is a personal trading journal and analytics tool. It does not provide financial advice, investment advice, tax advice, or legal advice of any kind.</strong>
              </p>
              <p>
                Nothing displayed on the DISApline platform — including metrics, pattern alerts, performance statistics, win rates, expectancy figures, psychological insights, or any other output — constitutes a recommendation to buy, sell, or hold any financial instrument, security, derivative, cryptocurrency, or other asset.
              </p>
              <p>
                All data shown is derived solely from information you have entered. DISApline performs no independent analysis of markets and takes no view on any financial instrument.
              </p>
            </>
          ),
        },
        {
          ...
          content: (
            <>
              <p>
                DISApline S.R.L. is not a licensed or authorised investment firm, portfolio manager, financial intermediary, broker, or financial adviser under:
              </p>
              <ul>
              ...
              <p>
                DISApline is registered and operated as a software services company. Its activities are limited to the provision of productivity and journaling software tools and do not constitute any regulated financial activity.
              </p>
            </>
          ),
        },
        ...
        },
        {
          ...
          content: (
            <>
              <p>
                All metrics, analytics, and pattern detection shown in DISApline are computed from the trade data you enter. We do not independently verify the accuracy of your inputs. Accordingly:
              </p>
              <ul>
        ...
        },
        {
          ...
          content: (
            <>
              <p>
                Where DISApline offers integrations with third-party brokerage platforms, such integrations are provided solely as a data import convenience. DISApline:
              </p>
              <ul>
              ...
              <p>
                Your relationship with any broker is governed entirely by the terms and agreements between you and that broker. DISApline is not a party to those agreements.
              </p>
            </>
          ),
        },
        {
          ...
          content: (
            <>
              <p>
                DISApline may surface behavioural patterns and psychological insights based on your journaled data. These are intended as reflective tools to support self-awareness and discipline — they are:
              </p>
              <ul>
        ...
        },
        {
          ...
          content: (
            <>
              <p>
                DISApline does not provide tax advice or assist with regulatory compliance. You are solely responsible for:
              </p>
              <ul>
